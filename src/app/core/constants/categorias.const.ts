export const CATEGORIAS = [
  { id: 'alimentacion', nombre: 'Alimentación', icono: 'restaurant', color: 'warning' },
  { id: 'transporte', nombre: 'Transporte', icono: 'bus', color: 'primary' },
...
export const TIPOS_TRANSACCION = [
  { id: 'income', nombre: 'Ingreso' },
  { id: 'expense', nombre: 'Gasto' }
];